...
* Creation of endless popups
* Fredom to assign one different popup for each page
* Add a form for newsletter
* Modify graphically the popup style
...
Recently YITH WooCommerce Popup has been selected to be included in the "translate.wordpress.org" translate programme.
...
* yith-woocommerce-popup-[WORDPRESS LOCALE].po
* yith-woocommerce-popup-[WORDPRESS LOCALE].mo

== Screenshots ==

1. Popup Setting Page
2. Page for creation of a popup
3. Options for the creation of a popup
...
= 1.2.3 -  Released: Mar 03, 2018 =
* New: Support to WooCommerce 3.3.x
* Fix: Select 2 for select where you want to show the popup
* Fix: Plugin Core Icon issue

= 1.2.2 -  Released: Feb 01, 2018 =
* Fix: Plugin Core Icon issue

= 1.2.1 -  Released: Jan 31, 2018 =
* New: Support to WooCommerce 3.3.x
* Update: Plugin Core 3.0.11

= 1.2.0 -  Released: Dec 11, 2017 =
* Update: Plugin Core 3.0

= 1.1.1 -  Released: Apr 26, 2017 =
* New: Support to WooCommerce 3.0.4
* Fix: Javascript error when the user clicks on close button
* Update: Plugin Core

= 1.1.0 -  Released: Mar 31, 2017 =
* New: Support to WooCommerce 3.0 RC 2
* Update: Plugin Core

= 1.0.4 -  Released: Aug 04, 2016 =
