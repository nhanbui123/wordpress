...
* Description: <code><strong>YITH WooCommerce Popup</strong></code> lets you easily manage and customize all the popups of your site. <a href="https://yithemes.com/" target="_blank">Find new awesome plugins on <strong>YITH</strong></a>.
* Version: 1.2.5
* Author: YITHEMES
...
if ( defined( 'YITH_YPOP_PREMIUM_INIT' ) ) {
    function yith_ypop_install_free_admin_notice() {
        ?>
        <div class="error">
            <p><?php _e( 'You can\'t activate the free version of YITH WooCommerce Popup while you are using the premium one.', 'yith-woocommerce-popup' ); ?></p>
        </div>
        <?php
    }
...
if ( defined( 'YITH_YPOP_VERSION' ) ) {
    ...
    define( 'YITH_YPOP_VERSION', '1.2.5' );
}
...
function yith_ypop_free_constructor() {
    ...
    if ( !function_exists( 'WC' ) ) {
        function yith_ypop_install_woocommerce_admin_notice() {
            ?>
            <div class="error">
                <p><?php _e( 'YITH WooCommerce Popup is enabled but not effective. It requires WooCommerce in order to work.', 'yith-woocommerce-popup' ); ?></p>
            </div>
            <?php
        }
