...
function ywsfd_install_free_admin_notice() {
    ?>
    <div class="error">
        <p><?php _e( 'You can\'t activate the free version of YITH WooCommerce Share For Discounts while you are using the premium one.', 'yith-woocommerce-share-for-discounts' ); ?></p>
    </div>
    <?php
}
